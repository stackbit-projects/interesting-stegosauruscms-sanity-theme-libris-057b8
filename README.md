...
1. Run the following command to fetch the content from Sanity:
        ...
        npx @stackbit/stackbit-pull --stackbit-pull-api-url=https://stg-api.stackbit.com/pull/602057b81cef9100162811d8
...
To start editing your site, you can use the Sanity interface at https://interesting-stegosauruscms-sanity-theme-libris-057b8.sanity.studio/.
...
Generated at `2021-02-07T21:12:34.247Z` by Stackbit version `0.3.48`.